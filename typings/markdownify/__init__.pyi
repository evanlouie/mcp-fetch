...
def abstract_inline_conversion(
    markup_fn,
):  # -> Callable[..., Any | LiteralString | Literal['']]:
    """
...
class MarkdownifyOptions(TypedDict, total=False):
    heading_style: str
    bullet_style: str
    code_language: str
    code_language_callback: str
    convert: bool
    default_title: str
...
def markdownify(html: str, **options: MarkdownifyOptions) -> str: ...
